...
// The standard `forged completion <bash|zsh|fish|powershell>` command is
// generated by cobra itself (InitDefaultCompletionCmd) — do not register a
// command with that name here, it would block the injection and leave a
// dead command that renders help instead of scripts.
